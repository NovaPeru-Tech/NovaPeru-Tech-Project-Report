...
<table border="1" style="border-collapse: collapse; width: 100%;font-size: 1px; font-family: Arial, sans-serif;"">
  ...
  <tr>
    ...
    <strong>Y</strong> el visitante hace clic (o toca) un enlace del menú, <br>
  ...
  <strong>Escenario 2: Menú no carga o enlace roto</strong> <br>
    <strong>Dado que</strong> el visitante se encuentra en la landing page, <br>
    <strong>Cuando</strong> el menú no se renderiza correctamente o al hacer clic en un enlace la ruta devuelve error/404, <br>
  ...
  <tr>
    ...
    <strong>Cuando</strong> selecciona un plan específico y hace clic en "Seleccionar", <br>
  ...
  <tr>
    ...
    <strong>Y</strong> al hacer clic, se abren en nueva pestaña las páginas oficiales de Veyra, <br>
  ...
  <strong>Escenario 2: Enlaces de redes sociales no funcionales</strong> <br>
    ...
    <strong>Cuando</strong> hace clic en un ícono de red social que no funciona, <br>
  ...
  <tr>
    ...
    <strong>Y</strong> hace clic en "Enviar", <br>
  ...
  <strong>Escenario 2: Formulario con datos inválidos</strong> <br>
    ...
    <strong>Y</strong> puede corregir errores y reenviar.
    </td><td>EP02</td>
  </tr>
  <tr>
    ...
    <strong>Cuando</strong> hace clic en el botón de cambio de idioma y selecciona inglés, <br>
